    ...
    <div class="card">
        <div class="card-body">
            <div class="stat-widget-one">
                <div class="stat-icon dib"><i class="fa fa-eye text-success border-success"></i></div>
                <div class="stat-content dib">
                    <div class="stat-text">Pesan Belum Dibaca</div>
                <div class="stat-digit">{{$masuk}}</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-6 col-md-6">
    <div class="card">
        <div class="card-body">
            <div class="stat-widget-one">
                <div class="stat-icon dib"><i class="fa fa-paper-plane text-success border-success"></i></div>
                <div class="stat-content dib">
                    <div class="stat-text">Jumlah Pesan</div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="stat-widget-one">
                ...
                <div class="stat-content dib">
                    <div class="stat-text">Jumlah Total Pesan</div>
